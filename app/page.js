      ...
      <section className="hero" id="home">
        ...
        <div className="hero-grid shell">
          ...
          <div className="hero-art hero-art-ganesha" aria-label="Illustration of Lord Ganesha">
            <img src={asset("/om-utsava-hero-ganesha-feathered.png")} alt="Lord Ganesha emerging through ivory and maroon draped fabric" />
      ...
      <section className="donate reveal" id="donate">
        <div className="shell donate-grid">
          ...
          <form className="donate-card" onSubmit={pledge}>
            ...
            <small>Payments are securely processed by Cashfree. By contributing, you agree to our <a href="/policies">Policies</a>.</small>
          </form>
        </div>
      </section>
